...
public static class SetDefaultInstallationRoute
{
    ...
    public static RouteHandlerBuilder AddSetDefaultInstallationRoute(this IEndpointRouteBuilder app)
    {
        return app.MapPost(Route, async Task<Results<Ok, NotFound>> (
            SetDefaultInstallationRequest request,
