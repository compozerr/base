...
Deploying a module is a simple process that can be done with the `compozerr` CLI.

## How to

To deploy a module, use the following command:

```bash
compozerr deploy module <name>
```
