...
// @ts-ignore
import { CloseWindowMessageRequestBuilderRequestsMetadata, type CloseWindowMessageRequestBuilder } from './closeWindowMessage/index.js';
// @ts-ignore
...
export interface AuthRequestBuilder extends BaseRequestBuilder<AuthRequestBuilder> {
    /**
     * The closeWindowMessage property
     */
    get closeWindowMessage(): CloseWindowMessageRequestBuilder;
    /**
     * The login property
     */
...
export const AuthRequestBuilderNavigationMetadata: Record<Exclude<keyof AuthRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    closeWindowMessage: {
        requestsMetadata: CloseWindowMessageRequestBuilderRequestsMetadata,
    },
    login: {
