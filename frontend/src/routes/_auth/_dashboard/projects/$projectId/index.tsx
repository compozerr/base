        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <Badge className={getStateColor(getProjectStateFromNumber(project.state))}>{getProjectStateFromNumber(project.state)}</Badge>
                </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 gap-4 mt-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm "><a className='flex flex-row items-center' href={`https://github.com/${project.repoName}`} target='_blank'>{project.repoName} <ExternalLink height={15} /></a>                                  </p>
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-1 gap-4 mt-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm flex items-center gap-2">
                                        <span className={`h-2 w-2 rounded-full ${getStateColor(getProjectStateFromNumber(project.state))}`}></span>
