...
const addApiClientsToFrontend = async () => {
    await new Command(`cd frontend && openapi-qraft --plugin tanstack-query-react --plugin openapi-typescript http://localhost:${Config.ports.backend}/swagger/v1/swagger.json --clean -o src/generated --export-type --properties-required-by-default --default-non-nullable`, "", {
        silent: true
    }).spawn();
